    ...
    <div className="w-full">
      ...
      <div ref={dropDownRef} className="relative cursor-pointer">
        ...
        {isOpen && availableOptions.length > 0 && (
          <div className="scrollbar scrollbar-thumb-slate-400 scrollbar-thumb-rounded-xl scrollbar-w-2 absolute top-full left-0 z-10 mt-1 w-full flex-col gap-2 overflow-y-auto rounded-lg border border-slate-400 bg-white px-3 py-2 shadow-[0_4px_36px_0_rgba(0,0,0,0.02)]">
